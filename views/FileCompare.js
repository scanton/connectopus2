(function() {
	...
	var s = `
		<span v-bind:data-name="compareFile.name" v-bind:title="getTitle()" v-bind:class="{'is-sync-action': primeFile.md5 != null && index == 0, 'is-delete-action': primeFile.md5 == null && index == 0, 'is-not-in-sync': primeFile.md5 != compareFile.md5}" class="file-compare">
